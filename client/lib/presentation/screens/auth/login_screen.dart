...
import 'package:myapp/presentation/screens/auth/pass_reset.dart';
import 'package:myapp/presentation/screens/auth/signup_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text("Sign in to continue", style: TextStyle(color: Colors.grey[700])),
      ],
    );
  }
}